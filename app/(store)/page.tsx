        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 lg:gap-8">
            {MOCK_CATEGORIES.map((category, idx) => (
              <ScrollReveal key={category.slug} delay={idx * 100}>
                <Link href={`/produits?category=${category.slug}`} className="group relative overflow-hidden rounded-2xl aspect-[4/3] block">
